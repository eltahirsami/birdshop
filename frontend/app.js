...
const INVOICE_STYLE = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: Arial, sans-serif; width: 56mm; font-size: 12px; color: #000; background: #fff; direction: rtl; margin: 0 auto; padding: 0 2mm 0 0; }
